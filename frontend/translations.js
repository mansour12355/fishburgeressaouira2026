...
const translations = {
    ...
    "Now with 2 locations and a growing team, Fishburger continues to shake up the food scene—bringing fresh, local fish and bold ideas to everyone who walks through our doors.": { "es": "Ahora, con 2 ubicaciones y un equipo en crecimiento, Fishburger continúa sacudiendo la escena culinaria: trayendo pescado local fresco e ideas audaces a todos los que entran por nuestras puertas.", "ar": "الآن ، مع موقعين وفريق متنامٍ ، يواصل فيش برجر هز مشهد الطعام - حيث يقدم أسماكًا محلية طازجة وأفكارًا جريئة لكل من يمر عبر أبوابنا.", "fr": "Maintenant avec 2 emplacements et une équipe grandissante, Fishburger continue de bousculer la scène culinaire en apportant du poisson local frais et des idées audacieuses à tous ceux qui franchissent nos portes." },
    "A glimpse into our kitchen, our port, and the soul of Essaouira's finest seafood.": { "es": "Un vistazo a nuestra cocina, nuestro puerto y el alma de los mejores mariscos de Essaouira.", "ar": "لمحة عن مطبخنا ومينائنا وروح أفضل المأكولات البحرية في الصويرة.", "fr": "Un aperçu de notre cuisine, de notre port et de l'âme des meilleurs fruits de mer d'Essaouira." },
    ...
    "Where the vibrant energy of the Medina meets our global community of food lovers.": { "es": "Donde la energía vibrante de la Medina se encuentra con nuestra comunidad global de amantes de la comida.", "ar": "حيث تلتقي الطاقة النابضة بالحياة في المدينة مع مجتمعنا العالمي من عشاق الطعام.", "fr": "Où l'énergie vibrante de la médina rencontre notre communauté mondiale de gourmands." },
    "Daily Delivery": { "es": "Entrega Diaria", "ar": "التوصيل اليومي", "fr": "Arrivage du Jour" },
    "Our team brings the best catch of the day straight from the blue boats to your tray.": { "es": "Nuestro equipo trae la mejor pesca del día directamente desde los barcos azules hasta su bandeja.", "ar": "يجلب فريقنا أفضل صيد في اليوم مباشرة من القوارب الزرقاء إلى صينيتك.", "fr": "Notre équipe apporte la meilleure pêche du jour directement des bateaux bleus à votre plateau." },
    "The Perfect Bite": { "es": "El Bocado Perfecto", "ar": "اللقمة المثالية", "fr": "La Bouchée Parfaite" },
    "Layers of fresh local fish, crisp greens, and our signature secret sauces.": { "es": "Capas de pescado local fresco, verduras crujientes y nuestras salsas secretas de autor.", "ar": "طبقات من الأسماك المحلية الطازجة، والخضروات المقرمشة، والصلصات السرية المميزة لدينا.", "fr": "Des couches de poisson local frais, de légumes croquants et de nos sauces secrètes signatures." },
